...
const BookIdParamCurrPageParamLazyImport = createFileRoute("/$bookIdParam/$currPageParam")()
...
const BookIdParamCurrPageParamLazyRoute = BookIdParamCurrPageParamLazyImport.update({
	path: "/$bookIdParam/$currPageParam",
	getParentRoute: () => rootRoute
} as any).lazy(() => import("./routes/$bookIdParam.$currPageParam.lazy").then(d => d.Route))
